...
exports.get = async (req, res) => {
  try {
    ...
    formatedData.payment_detail.default_currency = formatedData.default_currency;
...
exports.bookingHistories = async (req, res, next) => {
  try {
    ...
    const result = await Booking.aggregatePaginate(aggregateQuery, options);
    const customer = await User.findById(customerId).select("firstname lastname email country_code phone ").lean();
